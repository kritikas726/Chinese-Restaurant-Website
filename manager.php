...
<body>
  ...
  <?php
  include 'connect.php';
    $sql = "SELECT C_First_Name,C_Last_Name,C_Phone_No,C_Email_ID,C_Address,C_Landmark,Order_Price FROM Customer_Details";
    ...
    if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_assoc()) {
        ?>
                ...
                <tbody>
                    <tr>
                    <td scope="row"><?php echo $row["C_First_Name"]; ?></td>
                    <td scope="row"><?php echo $row["C_Last_Name"]; ?></td>
                    <td scope="row"><?php echo $row["C_Phone_No"]; ?></td>
                    <td scope="row"><?php echo $row["C_Email_ID"]; ?></td>
                    <td scope="row"><?php echo $row["C_Address"]; ?></td>
                    <td scope="row"><?php echo $row["C_Landmark"]; ?></td>
                    <td scope="row"><?php echo $row["Order_Price"]; ?></td>
                    </tr>
                </tbody>
<!-- End of #main-content -->
        <?php
