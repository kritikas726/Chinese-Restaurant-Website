...
<body>
  <header>
    ...
    <div class="form">
      <form>
        <h1 class="form-heading">Hello Manager!</h1>
        <div class="button-div">
            <button><a href="manager.php">VIEW REPORT</a></button>
        </div>
      </form>
    </div>
...
<body>
  <header>
    ...
    <div class="form">
      <form>
        <h1 class="form-heading">Login Failed!</h1>
        <div class="button-div">
            <button><a href="login.php">VIEW REPORT</a></button>
        </div>
      </form>
    </div>
